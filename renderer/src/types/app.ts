...
export interface GlobalAssistantSession {
  ...
  orchestrator?: NovelOrchestratorSessionState | null
  createdAt: string
  updatedAt: string
}

export type NovelOrchestratorPhase =
  | 'deconstruct'
  | 'inspiration'
  | 'premise'
  | 'master-outline'
...
export interface NovelOrchestratorResult {
  phase: NovelOrchestratorPhase
  phaseLabel: string
  summary: string
  recommendedNextAction: string
  confirmationRequired: boolean
  confirmationQuestion: string
  inspirationOptions: Array<{
    title: string
    type: string
    length: string
    targetWords: string
...
export interface NovelOrchestratorSessionState {
  lastResult: NovelOrchestratorResult
  status: 'proposed' | 'confirmed' | 'applied'
