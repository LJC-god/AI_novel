...
export function buildRunMeta(
  ...
  return {
    ...
    modelGroupId: settings.modelGroupId || undefined,
    modelGroupName: settings.modelGroupName || undefined,
    modelRoleId: settings.modelRoleId || undefined,
    modelRoleLabel: settings.modelRoleLabel || undefined,
    status,
    startedAt,
    finishedAt,
    durationMs,
