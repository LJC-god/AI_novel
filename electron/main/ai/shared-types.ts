...
export type NovelOrchestratorResult = {
  ...
  worldviewDrafts: WorldviewResult[]
  characterDrafts: CharacterResult[]
  volumeDrafts: Array<{
    title: string
    wordTarget: string
    summary: string
  }>
  chapterOutlineDrafts: OutlineResult[]
  assetPlan: Array<{
    assetType: string
    title: string
    purpose: string
