...
const novelOrchestratorPhaseSchema = z.enum([
  'deconstruct',
  'inspiration',
  'premise',
  'master-outline',
...
const taskObjectSchemas: Partial<Record<AiTaskName, z.ZodTypeAny>> = {
  ...
  'novel-orchestrator': z.object({
    phase: novelOrchestratorPhaseSchema,
    phaseLabel: stringField,
    summary: stringField,
    recommendedNextAction: stringField,
    confirmationRequired: z.boolean(),
    confirmationQuestion: stringField,
    inspirationOptions: z.array(z.object({
      title: stringField,
      type: stringField,
      length: stringField,
      targetWords: stringField,
      platform: stringField,
      hook: stringField,
      risk: stringField
    })),
    inspirationDrafts: z.array(z.object({
      type: stringField,
      title: stringField,
      content: stringField,
      tags: stringList
    })),
    outlinePlan: z.array(z.object({
      title: stringField,
      scope: stringField,
      purpose: stringField,
      conflict: stringField
    })),
    worldviewDrafts: z.array(worldviewEntrySchema),
    characterDrafts: z.array(z.object({
      name: stringField,
      role: stringField,
      description: stringField,
      tags: stringList
    })),
    volumeDrafts: z.array(z.object({
      title: stringField,
      wordTarget: stringField,
      summary: stringField
    })),
    chapterOutlineDrafts: z.array(outlineItemSchema),
    assetPlan: z.array(z.object({
      assetType: stringField,
      title: stringField,
      purpose: stringField,
      dependsOnConfirmation: z.boolean()
    })),
    modelRoles: z.array(z.object({
      role: stringField,
      suggestedModelClass: stringField,
      reason: stringField
    })),
    nextPrompts: stringList,
    notes: stringList
  }),
