...
export function normalizeSettings(settings: AppSettings): AppSettings {
  ...
  return {
    ...
    baseUrl,
    modelGroupId: settings.modelGroupId?.trim() || '',
    modelGroupName: settings.modelGroupName?.trim() || '',
    modelRoleId: settings.modelRoleId?.trim() || '',
    modelRoleLabel: settings.modelRoleLabel?.trim() || '',
